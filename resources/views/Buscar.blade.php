...
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar" style="background: rgb(102, 59, 201);">
  ...
  <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
    ...
    <li> <form class="form-inline my-2 my-lg-0">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit"> <a class="nav-link" onclick="window.location.href='/Buscar'"><i class="fas fa-search" id="icnBuscar"></i></a> 
                        </button>
                </form></li>
